...
public class ImageAdapter extends BaseRVAdapter<ImageBean, ImageAdapter.Holder> {
    private RequestOptions glideOptions = RequestOptions.placeholderOf(R.mipmap.ic_launcher)
            .diskCacheStrategy(DiskCacheStrategy.AUTOMATIC);

    @Override
    public void onBindHolder(@NonNull Holder holder, ImageBean item, int position) {
